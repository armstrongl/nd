...
| [Export a plugin or marketplace](docs/guide/export-plugin-workflow.md) | Load when modifying the export workflow: plugin packaging, marketplace generation, or export flags. | 2026-07-05 | current | `cmd/export.go`<br>`internal/export/**` |
...
| [Interactive TUI](docs/guide/tui.md) | Load when modifying the interactive terminal UI: screens, navigation, key bindings, header, or scope switching. | 2026-07-05 | current | `internal/tui/**`<br>`cmd/root.go` |
...
| [Team and project config](docs/guide/team-config.md) | Load when configuring shared team sources, git URLs, symlink strategy, or project-scoped versus user-scoped config. | 2026-07-05 | current | `internal/config/**`<br>`internal/sourcemanager/**`<br>`cmd/deploy.go` |
